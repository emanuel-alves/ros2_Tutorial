...
: ${AMENT_CURRENT_PREFIX:="/mnt/HomeWin/projetos/tutorial_ros2/dev_ws/install/cpp_chat"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_chat/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_chat/environment/path.sh"
