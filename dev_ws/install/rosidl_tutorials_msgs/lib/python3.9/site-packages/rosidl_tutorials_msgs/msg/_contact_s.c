...
bool rosidl_tutorials_msgs__msg__contact__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosidl_tutorials_msgs.msg._contact.Contact", full_classname_dest, 42) == 0);
  }
  rosidl_tutorials_msgs__msg__Contact * ros_message = _ros_message;
  {  // first_name
...
PyObject * rosidl_tutorials_msgs__msg__contact__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rosidl_tutorials_msgs.msg._contact");
