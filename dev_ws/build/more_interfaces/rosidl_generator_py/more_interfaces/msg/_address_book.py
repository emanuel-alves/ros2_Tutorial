...
class Metaclass_AddressBook(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosidl_tutorials_msgs.msg import Contact
...
class AddressBook(metaclass=Metaclass_AddressBook):
    ...
    _fields_and_field_types = {
        'address_book': 'sequence<rosidl_tutorials_msgs/Contact>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rosidl_tutorials_msgs', 'msg'], 'Contact')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.address_book = kwargs.get('address_book', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.address_book != other.address_book:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'address_book' field must be a set or sequence and each value of type 'Contact'"
