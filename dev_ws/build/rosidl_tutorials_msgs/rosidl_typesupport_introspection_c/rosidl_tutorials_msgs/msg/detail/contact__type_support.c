...
static rosidl_typesupport_introspection_c__MessageMember Contact__rosidl_typesupport_introspection_c__Contact_message_member_array[5] = {
  {
    "first_name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_tutorials_msgs__msg__Contact, gender),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_tutorials_msgs__msg__Contact, age),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_tutorials_msgs__msg__Contact, address),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
